export default{
  ...
  intro: {
    ...
    title2:'一个ID就够了',
    subtitle2:'通过一套助记词绑定一个start ID，即可管理所有 70+ 主链的各种数字货币',
    subtitle3:'CoinStart独创的加密算法，为您的数字资产安全保驾护航'
  },
  features:{
    feature1a:'Start ID',
    feature1b:'Start ID独一无二性 确认注册资格后，便可注册得到独一无二Start ID，CID不会与手机号又任何关联，用户通过手机只做验证用；',
    feature2a: 'Socialfi-专为加密社群设计的免费IM',
    feature2b: 'Socialfi-专为加密社群设计的免费网路即时通话软体，不仅只从加密聊天开始， GameFi defi 新手老手都适用的社群交流平台，支持红包，社交，群聊，支付。',
